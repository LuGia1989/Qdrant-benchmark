...
class QdrantLocal(VectorDB):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        client = QdrantClient(**self.db_config, prefer_grpc=True)
    ...
    def init(self):
        ...
        """
        # create connection
        self.client = QdrantClient(**self.db_config, prefer_grpc=True)
        yield
        self.client = None
        del self.client
    ...
    def _create_collection(self, dim: int, qdrant_client: QdrantClient):
        ...
        try:
            ...
            # create payload_index for int-field (pk)
            ...
            # create payload_index for str-field (label) if needed
    ...
    def prepare_filter(self, filters: Filter):
        if filters.type == FilterOp.NonFilter:
            ...
            msg = f"Not support Filter for QdrantLocal - {filters}"
